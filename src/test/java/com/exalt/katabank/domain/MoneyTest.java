...
public class MoneyTest {
    ...
    @Test
    public void when_two_positive_numbers_add_then_return_correct_result(){
    ...
    @Test
    public void when_negative_and_positive_numbers_subtract_then_return_correct_result(){
        Money m1 = new Money("100.40");
        Money m2 = new Money("-20.40");
    ...
    @Test
    public void when_m1_positive_then_return_true(){
        Money m1 = new Money("100.40");
